            ...
            <div className="container d-flex justify-content-center mb-5">
                <form className="row g-3">
                    <div className="col-12 mb-3">
                        ...
                        <input type="text" className="form-control" id="nome" placeholder="Insira seu nome" required />
                    </div>
                    <div className="col-12 mb-3">
                        <label className="form-label">Matrícula
                            <span className="text-danger ms-1">*</span>
                        </label>
                        <input type="number" className="form-control [&::-webkit-inner-spin-button]:appearance-none" id="matricula" placeholder="Insira sua matrícula" required />
                    </div>
                    <div className="col-12 mb-3">
                        <label className="form-label">E-mail UFBA
                            <span className="text-danger ms-1">*</span>
                        </label>
                        <input type="email" className="form-control" id="email" placeholder="Insira seu e-mail" required />
                    </div>
                    <div className="col-12 mb-3">
                    ...
                    <div className="col-12 mb-5">
                        ...
                        <input type="password" className="form-control" id="password" placeholder="Insira sua senha novamente" required />
                    </div>
