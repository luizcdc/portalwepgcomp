            ...
            <div className="container d-flex justify-content-center mb-5">
                <form className="row g-3">
                    <div className="col-12 mb-3">
                        ...
                        <input type="email" className="form-control" id="email" placeholder="exemplo@ufba.br" required />
                    </div>
                    <div className="col-12 mb-3">
                        ...
                        <div className="text-end">
                            <a href="#" className="link-underline link-underline-opacity-0">Esqueceu sua senha?</a>
                        </div>
                    </div>
