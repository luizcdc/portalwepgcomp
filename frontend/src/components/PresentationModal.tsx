...
export default function PresentationModal({props} : {props: presentationData}) {
    return (
        <div style={{padding: "0 25px 25px 25px", display: "flex", flexDirection: "column", gap: "10px", alignItems: "flex-start",  color: "black"}}>
            ...
            <div>
                <p style={{backgroundColor: "#F17F0C", color: "white", borderRadius: "5px", padding: "4px 10px", margin: "0px"}}>{props.date} - {props.local} - {props.time}</p>
            </div>
