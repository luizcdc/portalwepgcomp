  ...
  return (
    ...
    >
      <div className="row mb-3">
        <div className="col-6">
          <label className="form-label form-title text-white fw-semibold">Nome:</label>
          <input
            type="nome"
        ...
        <div className="col-6">
          <label className="form-label form-title text-white fw-semibold">E-mail:</label>
          <input
            type="email"
            className="form-control input-title bg-transparent border-1 text-white shadow-none"
      ...
      <div>
        <label className="form-label form-title text-white fw-semibold">Mensagem:</label>
        <textarea
