...
export const PresentationProvider = ({ children }: PresentationProps) => {
    ...
    const getPresentationBookmark = async (presentationBookmark: PresentationBookmarkRegister) => {
        return presentationApi.getPresentationBookmark(presentationBookmark)
            .then((response) => {
    ...
    const deletePresentationBookmark = async (presentationBookmark: PresentationBookmarkRegister) => {
        presentationApi.deletePresentationBookmark(presentationBookmark)
            .finally(() => {});
    }
